...
class Penjadwalan extends CI_Controller {
    ...
    function update(){
        ...
        public function print(){
            ...
            $pdf->Cell(40,10,'SMK Puja Bangsa',0,0,'C');
            $pdf->Ln(4);
            $pdf->SetX(103);
            $pdf->SetFont('Arial','',8);
            $pdf->Cell(40,10,'Karangasih, Kec. Cikarang Utara, Bekasi, Jawa Barat 17530');
            $pdf->SetFont('Arial','',8);
            $pdf->Ln(4);
            $pdf->SetX(125);
            ...
            $pdf->SetX(120);
            $pdf->SetFont('Arial','B',12);
            $pdf->Cell(40,10,'Jadwal Mata Pelajaran SMK Puja Bangsa',0,0,'C');
            $pdf->Ln(4);
             //Table
             $pdf->Ln(8);
             $pdf->SetFont('Arial','',8);
