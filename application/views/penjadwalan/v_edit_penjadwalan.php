...
<?php foreach ($jadwal as $roweditjadwal) {
  $id=$roweditjadwal->id_jadwal;
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-sm-12 col-xs-12">
                  <div class="form-wrap">
                    <form action="<?php echo base_url()?>index.php/penjadwalan/update" method="POST">
                      <div class="form-body">
                        <h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Edit Data Penjadwalan</h6>
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control" name="nip">
                                  ...
                                  <?php foreach($guru as $rowguru){
                                    ?>
                                    <option value="<?php echo $rowguru->nip?>"><?php echo $rowguru->nama_guru?></option>
                                  <?php } ?>
                                </select>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <span class="help-block">Isi Jam Selesai</span> 
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <select class="form-control" name="hari">
                                  ...
                                  <option>Rabu</option>
                                  <option>Kamis</option>--Pilih--
                                  <option>Jumat</option>
                                </select>
                                <span class="help-block">Isi Hari</span> 
                              </div>
                            </div>
                            <br>
